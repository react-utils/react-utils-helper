        ...
        <footer className="bs-docs-footer" role="contentinfo">
          <div className="container">
            ...
            <ul className="bs-docs-footer-links muted">
              ...
              <li>·</li>
              <li><a href="https://github.com/react-utils/react-utils-helper">GitHub</a></li>
              <li>·</li>
              <li><a href="https://github.com/react-utils/react-utils-helper/issues">Issues</a></li>
              <li>·</li>
              <li><a href="https://github.com/react-utils/react-utils-helper/releases">Releases</a></li>
            </ul>
          </div>
        </footer>
      );
