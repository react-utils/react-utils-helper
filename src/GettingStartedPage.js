...
var Page = React.createClass({
    ...
    return (
        <div>
          ...
          <PageHeader
            ...
            subTitle="An overview of React Component Helper and how to install and use." />
            ...
            <div className="row">
              <div className="col-md-9" role="main">
                <div className="bs-docs-section">
                  ...
                  <p className="lead">You can import the lib with as CommonJS modules as a global JS script.</p>
                  <h3>CommonJS</h3>
  ...
  var Input = require(\'react-bootstrap/lib/Input\');\n\
                 ...
                 {/* <h3>AMD</h3>
                  ...
                  <p className="lead">You have to include a mixin for two way data binding between state and view.</p>
                  <h3>CommonJS</h3>
                  <div className="highlight">
